...
const PATHS: Record<IconName, string> = {
  ...
  chartBar: '<path d="M3 3v18h18"/><rect x="7" y="12" width="4" height="6" rx="1"/><rect x="13" y="7" width="4" height="11" rx="1"/>',
...
/** Devuelve el SVG inline de un icono (compatible con la UI heredada). */
export function renderIcon(name: IconName, options: { size?: number } = {}): string {
  const size = options.size ?? 20;
  const path = PATHS[name] ?? PATHS.information;
